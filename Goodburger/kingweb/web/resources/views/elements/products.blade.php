                        ...
                        <div class="sidebar mb-35">
                            ...
                            <ul class="product-categories">
                                @foreach($subcat as $key => $data)
                                    <li><img src="img/ok.png" class="okicon"/> <a class="active" href="category?cat={{$data->id}}">{{$data->name}}</a> </li>
                                @endforeach
                            </ul>
                        </div>
                @endif
                ...
                <div class="shop-header mb-35">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12 d-flex flex-column flex-sm-row justify-content-between align-items-left align-items-sm-center">
                            ...
                            <p id="resultPages" class="result-show-message">{{$lang->get(2)}}{{$page*12-11}}–{{$count_current+($page-1)*12}}{{$lang->get(3)}}{{$count}}{{$lang->get(4)}}</p>  {{--"Showing ", " of " " results"--}}
                        </div>
                    </div>
                </div>
