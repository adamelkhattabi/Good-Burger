                            ...
                            <div class="myaccount-content">
                                ...
                                <div class="account-details-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <button onclick="saveAccountData();" class="save-change-btn">{{$lang->get(83)}}</button> {{--Save Changes--}}
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <button onclick="savePassword();" class="save-change-btn">{{$lang->get(87)}}</button> {{--Save Password--}}
                                        </div>
