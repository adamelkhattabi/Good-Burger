                                ...
                                <div class="col-md-6 foodm">
                                    ...
                                    <div class="col-md-12 foodm">
                                        ...
                                        <div class="col-md-10 foodm">
                                            <div class="form-group form-group-lg form-float">
                                                <div class="form-line">
                                                    <input type="text" name="symbol" id="symbol" class="form-control" placeholder="" maxlength="2" minlength="1">
                        ...
                        <div class="col-md-6 foodm">
                            ...
                            <div class="col-md-12 foodm">
                                ...
                                <div class="col-md-10 foodm">
                                    <div class="form-group form-group-lg form-float">
                                        <div class="form-line">
                                            <input type="text" name="symbol" id="symbolEdit" class="form-control" placeholder="" maxlength="2" minlength="1">
                                        </div>
