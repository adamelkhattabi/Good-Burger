...
class InstallController extends Controller
{
    ...
    public static function update()
    {
        ...
        if (!Schema::hasTable('docs')) {
            ...
            DB::table('docs')->insert(['param' => 'copyright_text', 'value' => '2021 KingBurger All Rights Reserved', 'created_at' => new \DateTime(), 'updated_at' => new \DateTime(),]);
        ...
        //
        DB::table('settings')->where("param", 'version')->update(['value' => '1.0', 'updated_at' => new \DateTime(),]);
    }
}
